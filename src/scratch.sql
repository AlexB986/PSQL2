...
SELECT * FROM scypro WHERE length(first_name) >4;
...
SELECT first_name AS имя,MIN(age) AS min_возраст FROM scypro  GROUP BY имя ;


SELECT first_name, age FROM scypro ORDER BY age;
